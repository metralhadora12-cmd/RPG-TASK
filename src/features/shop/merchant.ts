...
export const merchantEquipment: Equipment = {
  ...
  layers: {
    hat: [
      { id: 'merchant-hat', rows: expandLayer(A.hatStraw), palette: { ...basePalette, c: '#8a5a30', C: '#5a3818', a: '#e8c040' } },
    ],
    accessory: [{ id: 'mustache', rows: expandLayer(A.npcMustache), palette: { ...basePalette, H: '#b8bcc8' } }],
  },
};
